...
export default function ReservationsPage() {
  ...
  const handleDelete = async (id: string) => {
    try {
      setDeletingId(id)
      const data = await api.delete(`/api/v1/reservations/${id}`)
    ...
    <div className="container py-10">
      <div className="flex flex-col gap-6">
        <div className="text-center">
          ...
          <p className="text-muted-foreground mt-2">Manage your upcoming room reservations</p>
        </div>
        ...
        {reservations.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-16 bg-gray-50 rounded-lg border">
            ...
            <p className="text-muted-foreground mt-2 mb-6">You haven&apos;t made any reservations yet</p>
            <Button asChild>
              ...
              <Card key={reservation._id} className="hover:shadow-md transition-shadow">
                ...
                <CardContent className="space-y-3">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span>
                      <span className="font-medium">Capacity:</span> {reservation.capacity} people
                    </span>
                  </div>
                </CardContent>
